...
fun LiquidBottomTabs(
    ...
    val containerColor =
        if (isLightTheme) Color.White.copy(0.45f)
        else Color(0xFF1E1E1E).copy(0.55f)
    ...
    BoxWithConstraints(
        ...
        val dampedDragAnimation = remember(animationScope) {
            DampedDragAnimation(
                ...
                onDragStarted = { position ->
                    val newIndex = (position.x / tabWidth - 0.5f).fastCoerceIn(0f, (tabsCount - 1).toFloat())
        ...
        // Row 1: The main Glass Bottom Bar container - strong blur and lens refraction, zero white overlay!
        Row(
            Modifier
                .graphicsLayer {
        ...
        // Row 2: Hidden layer that captures ONLY the tab icons/text (no raw backdrop to prevent ghosting)
        ...
        // Box 3: The Glass Slider (sliding thumb) - uses layout placement for EXACT coordinates sampling!
        Box(
            Modifier
                .padding(horizontal = 4f.dp)
        ...
        // Box 4: Global Gesture Interceptor
        Box(
            Modifier
                .matchParentSize()
                .then(interactiveHighlight.gestureModifier)
